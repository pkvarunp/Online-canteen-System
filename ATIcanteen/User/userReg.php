        ...
        <form action="" class="shadow-lg px-5 pb-5 pt-5 formcontainer text-white " method="POST" >
          <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                  <i class="fa fa-mobile-phone iconCol"></i><label for="mobile" class="font-weight-bold pl-2" >ID Number</label>
                  <input type="text" class="form-control" placeholder="ID Number" name="rMobile" autocomplete="off" required>
                </div>
                <div class="form-group">
